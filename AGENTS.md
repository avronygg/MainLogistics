...
## Contexto de diseño — Logística Trade
...
3. `brand/logistica-trade-marca.md` — documento de marca original del cliente. Es la fuente; donde `DESIGN.md` se aparta de él, la razón está anotada.
...
- **Ninguna cifra ni certificación entra al sitio sin confirmación del cliente.** Ver la lista de pendientes en `brand/logistica-trade-marca.md` §11.
